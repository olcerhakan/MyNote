...
namespace MyNote.Desktop
{
    ...
    public partial class form : Form
    {
        ...
        private string ApiUrl => "https://mynoteapi.hakanolcer.xyz";
        ...
        private async Task<string> GetTokenAsync()
        {
                ...
                if (response.IsSuccessStatusCode)
                {
                                                            //IDENTITY TOKEN şeklinde serilize ediyoruz
                    IdentityToken identityToken = response.Content.ReadAsAsync<IdentityToken>().Result;
